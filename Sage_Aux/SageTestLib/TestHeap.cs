    ...
    public class HeapTester
    {
        ...
        public void TestHeap()
        {
            ...
            for (int testNum = 0; testNum < nTests; testNum++)
            {
                ...
                int nEntries = _random.Next(37) + 13;
                Heap.HEAP_RULE direction = _random.NextDouble() < 0.5 ? Heap.HEAP_RULE.MinValue : Heap.HEAP_RULE.MaxValue;
        ...
        private static Random _random = new Random(12);
