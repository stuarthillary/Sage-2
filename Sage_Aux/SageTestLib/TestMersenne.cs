...
namespace Highpoint.Sage.Randoms
{
    ...
    public class MersenneTester
    {
        ...
        public void PerformanceTestNoThreading()
        {
            ...
            Console.WriteLine("No threading test took " + (DateTime.Now - start));
        ...
        public void PerformanceTestWithThreading()
        {
            ...
            Console.WriteLine("Threading test took " + (DateTime.Now - start));
            rc.Dispose();
        }

        private void RunGoldTest(int bufferSize)
        {
            RandomServer rs = new RandomServer();
            Randoms.IRandomChannel rc = rs.GetRandomChannel(new ulong[] { 0x123, 0x234, 0x345, 0x456 }, bufferSize);
        ...
        readonly double[] _real32Gold = new double[]{    0.76275443 ,0.99000644 ,0.98670464 ,0.10143112 ,0.27933125
