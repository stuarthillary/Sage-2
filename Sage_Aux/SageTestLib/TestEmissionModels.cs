...
namespace Highpoint.Sage.Materials.Chemistry.EmissionModels
{
    ...
    public class EmissionModelTester
    {
        ...
        private Hashtable _computedVaporPressureIn;

        public EmissionModelTester()
        {
            Init();
        }
        ...
        public void MegaTest()
        {
            ...
            foreach (XmlNode testNode in doc.SelectNodes("/EmissionTests/Test"))
            {
                ...
                foreach (XmlNode modelResultNode in responseNode.SelectNodes("Model"))
                {
                    ...
                    Tester tester = new Tester(_brs, _lateBound);
                            ...
                            case ("fillVolumeInGallons"):
                                {
                                    ...
                                    MaterialType mt = _brs.MyMaterialCatalog["Unknown"];
                    ...
                    {
                        MaterialType mt = _brs.MyMaterialCatalog[substance];
...
@"<Initial><Material name=""Acetic Acid"" quantity=""0.667469348137951"" />
  ...
  <Material name=""Water"" quantity=""4.4795790335534"" />
        ...
        public void TestAirDry()
        {
            ...
            materialGuidToVolumeFraction.Add(_brs.MyMaterialCatalog["Water"].Guid, 0.5);
            materialGuidToVolumeFraction.Add(_brs.MyMaterialCatalog["Dimethylsulfide"].Guid, 0.5);
        ...
        public void TestMassBalance()
        {
            ...
            desiredEmissions.AddMaterial(_brs.MyMaterialCatalog["Water"].CreateMass(1, 37));
            desiredEmissions.AddMaterial(_brs.MyMaterialCatalog["Dimethylsulfide"].CreateMass(5, 37));
