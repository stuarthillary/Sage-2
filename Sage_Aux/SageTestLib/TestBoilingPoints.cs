...
namespace Highpoint.Sage.Materials.Chemistry.BoilingPoints
{
    ...
    public class BoilingPointTester
    {
        ...
        public void TestBoilingPoints()
        {
            ...
            Console.WriteLine("BP of water is " + _brs.MyMaterialCatalog["Water"].GetEstimatedBoilingPoint(pressure_1Atm) + ".");
            Console.WriteLine("BP of ethanol is " + _brs.MyMaterialCatalog["Ethanol"].GetEstimatedBoilingPoint(pressure_1Atm) + ".");

            _brs.MyMaterialCatalog.Add(new MaterialType(null, "Rock", Guid.NewGuid(), 4.5, 3.2, MaterialState.Solid, 76, 455));
            ...
            m.AddMaterial((Substance)_brs.MyMaterialCatalog["Water"].CreateMass(10.0, 37.0));
            m.AddMaterial((Substance)_brs.MyMaterialCatalog["Rock"].CreateMass(10.0, 37.0));
            _brs.MyMaterialCatalog["Rock"].STPState = MaterialState.Solid;

            Console.WriteLine("BP of " + m.Name + " is " + m.GetEstimatedBoilingPoint(pressure_1Atm) + ".");

            m = new Mixture("Primordium");
            m.AddMaterial((Substance)_brs.MyMaterialCatalog["Water"].CreateMass(10.0, 37.0));
            m.AddMaterial((Substance)_brs.MyMaterialCatalog["Ethanol"].CreateMass(10.0, 37.0));
        ...
        public void TestBoilingPoints2()
        {
            ...
            _brs.MyMaterialCatalog.Add(new MaterialType(null, "Tula4", Guid.NewGuid(), 1.0, 1.0, MaterialState.Solid, 299, 1.0));
            Substance heptane = (Substance)_brs.MyMaterialCatalog["Heptane"].CreateMass(940, 31);
            Substance methyleneChloride = (Substance)_brs.MyMaterialCatalog["Methylene Chloride"].CreateMass(1036, 31);
            Substance tula4 = (Substance)_brs.MyMaterialCatalog["Tula4"].CreateMass(217.2, 31);

            double pressure_1Atm = 101325.0; // pascals.
            Console.WriteLine("BP of Heptane is " + _brs.MyMaterialCatalog["Heptane"].GetEstimatedBoilingPoint(pressure_1Atm) + ".");
            Console.WriteLine("BP of Methylene Chloride is " + _brs.MyMaterialCatalog["Methylene Chloride"].GetEstimatedBoilingPoint(pressure_1Atm) + ".");
            Console.WriteLine("BP of Tula4 is " + _brs.MyMaterialCatalog["Tula4"].GetEstimatedBoilingPoint(pressure_1Atm) + ".");
            ...
            Substance water = (Substance)_brs.MyMaterialCatalog["Water"].CreateMass(100, 37);
        ...
        public void TestBoilingPoints3()
        {
            ...
            for (double d = 1.0; d >= 0.0; d -= .2)
            {
                ...
                Substance acetone = (Substance)_brs.MyMaterialCatalog["Acetone"].CreateMass(d * 100, 31);
        ...
        public void TestBoilingPointElevation()
        {
            ...
            mixture.AddMaterial(_brs.MyMaterialCatalog["Water"].CreateMass(1.0, 31));
