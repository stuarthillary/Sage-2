...
namespace Highpoint.Sage.Materials.Chemistry
{
    ...
    public class TransferSpecTester101
    {
        ...
        internal class TSTestJig
        {
            ...
            public MaterialType H2O_Type
            {
                get
                {
                    return _brs.MyMaterialCatalog["Water"];
                }
            }
            public MaterialType NANO2_Type
            {
                get
                {
                    return _brs.MyMaterialCatalog["Sodium Nitrite"];
                }
            }
            ...
            {
                _mixture.Clear();
                _mixture.AddMaterial(_brs.MyMaterialCatalog["Water"].CreateMass(mH2O, 20)); // Add 250 kg.
                _mixture.AddMaterial(_brs.MyMaterialCatalog["Sodium Nitrite"].CreateMass(mNANO2, 20)); // Add 100 kg NaNO2.
            }
            ...
            public TSTestJig(double mH2O, double mNANO2)
            {
                ...
                _brs.MyReactionProcessor.Watch(_mixture);
