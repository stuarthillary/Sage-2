...
namespace Highpoint.Sage.Materials.Chemistry
{
    ...
    public class MaterialResourceRequest : IResourceRequest
    {
        ...
        public MaterialResourceRequest(IHasIdentity byWhom, MaterialType mt, ICollection materialSpecs, double quantity, Direction direction)
        {
            ...
            Requester = byWhom;
            _materialType = mt;
            _materialSpecs = materialSpecs ?? new ArrayList();
            if (direction.Equals(Direction.Deplete))
            {
                _quantityDesired = quantity;
            }
            else
            {
                _quantityDesired = -quantity;
        ...
        public double Priority
        {
            ...
            set
            {
                double oldValue = _priority;
                _priority = value;
                PriorityChangeEvent?.Invoke(this, oldValue, _priority);
            }
        }
        #endregion
        ...
        private static bool DefaultGrantConfirmationRequest_Refuse(IResourceRequest request)
        {
            return false;
        }
        ...
        public ICollection MaterialSpecs => _materialSpecs;
        ...
        {
            return new MaterialResourceRequest(Requester, _materialType, _quantityDesired, Direction.Deplete);
        }
