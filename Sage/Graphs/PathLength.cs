...
namespace Highpoint.Sage.Graphs.Analysis
{
    ...
    public class PathLength
    {
        ...
        private static readonly bool _diagnostics = Diagnostics.DiagnosticAids.Diagnostics("PathLength");
        ...
        private static int shortestPathLength(Vertex from, Vertex to, ref ArrayList visitedNodes)
        {
            ...
            foreach (Edge edge in from.SuccessorEdges)
            {
                int pathLength = PathLength.shortestPathLength(edge.PostVertex, to, ref visitedNodes);
